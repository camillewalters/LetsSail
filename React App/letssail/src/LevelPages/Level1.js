...
import { Container, VStack, Text, Heading, Box, Avatar, Button, Link as ChakraLink } from '@chakra-ui/react';
...
function Level1() {
    ...
    useEffect(() => {
        addEventListener("LevelComplete", handleLevelComplete);//"NewScore" is the name of the callback event in the Plugin/WebGL/React.jslib file
        return () => {
