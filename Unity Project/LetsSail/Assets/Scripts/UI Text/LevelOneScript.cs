public class LevelOneScript
{
    ...
    public string[] introLines = 
    {
        ...
        "SKIPPERThe island only has food that can last us for four days.4",
        "SKIPPERWe need to sail to another island to get more supplies before we sail back home.4",
